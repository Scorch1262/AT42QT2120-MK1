...
void AT42QT2120_enableSlider(void);
void AT42QT2120_enableWheel(void);
uint8_t AT42QT2120_sliderPosition(void);
uint8_t AT42QT2120_wheelPosition(void);
# 8 "at42qt2120.c" 2
# 88 "at42qt2120.c"
uint8_t writeBuffer[3] = {0x00, 0x00, 0x00};
uint8_t readBuffer[10] = {0x00, 0x00};

void AT42QT2120_Init(void){
    AT42QT2120_enableSlider();
}

void AT42QT2120_enableSlider(void){
    I2C_Write1ByteRegister(0x1C, 14, 0x80);
}

void AT42QT2120_enableWheel(void){
    I2C_Write1ByteRegister(0x1C, 14, 0xC0);
}

uint8_t AT42QT2120_sliderPosition(void){
    readBuffer[0] = I2C_Read1ByteRegister(0x1C, 2);
    if((readBuffer[0] & 0b00000001) == 0b00000001){
        readBuffer[0] = I2C_Read1ByteRegister(0x1C, 5);
        return readBuffer[0];
    }
}
